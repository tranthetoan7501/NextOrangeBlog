...
export default function EditLink({ editor }: Props) {
  ...
  return (
    ...
    >
      ...
      />
      {!showEditForm && (
        <div className="rounded bg-orange-300 dark:bg-primary-dark text-primary-dark dark:text-primary shadow-secondary-dark shadow-md p-3 flex items-center space-x-6 z-50">
